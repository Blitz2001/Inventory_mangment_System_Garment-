...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .header-container, .message, .btn, .btn-create, .btn-edit, .btn-submit, .btn-cancel, .modal, .pagination, table:not(.print-table) {
        ...
        .print-header, .print-signatures, .print-table {
            display: none;
        }
    </style>
</head>
            ...
            ?>
                <tr>
                    ...
                    <td class="action-buttons">
                        ...
                        <a href="view_sale_receipt.php?id=<?php echo $row['Sales_ID']; ?>" class="btn btn-view" target="_blank">
...
<!-- Print Receipt (hidden except for print) -->
...
<div class="print-receipt">
    <div class="print-header">
        ...
        <div class="print-meta">
            <span><strong>Date:</strong> <?php echo date('M d, Y H:i'); ?></span>
        </div>
        <hr class="print-hr" />
    </div>
