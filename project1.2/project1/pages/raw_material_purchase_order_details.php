...
<head>
    ...
    <style>
        ...
        @media print {
            ...
            .header, .actions, .status-form, .message, .btn, .btn-back, .btn-print, .btn-receive, .btn-cancel, .status-form, .notes, .status-form, .actions {
...
<div class="container">
    <div class="print-header">
        ...
        <h1 style="font-size:2.2em; letter-spacing:2px; margin-bottom:0; border-bottom:2px solid #333; padding-bottom:10px;"><?php echo htmlspecialchars($companyName); ?></h1>
        <div class="print-meta" style="margin-top:8px;">
            <span style="font-size:1.2em;"><strong>Raw Material Purchase Order</strong></span>
        </div>
        <div class="print-meta">
            <span><strong>PO Number:</strong> <?php echo htmlspecialchars($rmp_data['rmp_number']); ?></span>
            <span><strong>Date:</strong> <?php echo date('M d, Y', strtotime($rmp_data['order_date'])); ?></span>
        </div>
        <div class="print-meta">
            <span><strong>Supplier:</strong> <?php echo htmlspecialchars($rmp_data['supplier_name']); ?></span>
            <?php if ($rmp_data['contact_person']): ?>
                <span><strong>Contact:</strong> <?php echo htmlspecialchars($rmp_data['contact_person']); ?></span>
            <?php endif; ?>
            <?php if ($rmp_data['phone']): ?>
                <span><strong>Phone:</strong> <?php echo htmlspecialchars($rmp_data['phone']); ?></span>
            <?php endif; ?>
            <?php if ($rmp_data['email']): ?>
                <span><strong>Email:</strong> <?php echo htmlspecialchars($rmp_data['email']); ?></span>
            <?php endif; ?>
        </div>
        <?php if ($rmp_data['address']): ?>
        <div class="print-meta">
            <span><strong>Address:</strong> <?php echo nl2br(htmlspecialchars($rmp_data['address'])); ?></span>
        </div>
        <?php endif; ?>
        <hr class="print-hr" />
    </div>
    ...
    <?php endif; ?>
    <div class="print-signatures" style="margin-top:60px; display:flex; justify-content:space-between; font-size:1em;">
        <div class="print-signature-block" style="width:30%; text-align:left;">
            <div class="print-signature-line" style="border-bottom:1px solid #333; width:90%; margin-bottom:5px; height:30px;"></div>
            <div class="print-signature-label">Prepared By</div>
            <div class="print-signature-date" style="font-size:0.95em; color:#555; margin-top:4px;">Date: ____________</div>
        </div>
        <div class="print-signature-block" style="width:30%; text-align:left;">
            <div class="print-signature-line" style="border-bottom:1px solid #333; width:90%; margin-bottom:5px; height:30px;"></div>
    ...
    <div class="print-footer" style="margin-top:40px; text-align:center; font-size:1.1em; color:#555;">
